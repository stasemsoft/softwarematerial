...
Maak in je nieuwe project een user interface voor het programma waarmee je een wachtwoord kunt invoeren. Voorzie de gebruiker van informatie: als het wachtwoord juist is wordt de ene tekst zichtbaar, als het wachtwoord onjuist is wordt de andere tekst zichtbaar.
